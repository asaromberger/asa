class RolesController < ApplicationController
	...
	def all_roles
		return(['siteadmin', 'health', 'bridge', 'bridge_bbo', 'music', 'genealogy', 'genealogy_admin', 'finance_trackings', 'finance_expenses', 'finance_investments', 'finance_admin', 'trace_mail'])
	end
