class Genealogy::Admin::BulkInputController < ApplicationController
	...
	def create
		...
		document = params[:document]
			...
			@traces.push("NOTE #{@indexes['NOTE'].count}")
			@traces.push("FAM #{@indexes['FAM'].count}")
			@traces.push("INDI #{@indexes['INDI'].count}")
			@traces.push("REPO #{@indexes['REPO'].count}")
			@traces.push("SOUR #{@indexes['SOUR'].count}")
